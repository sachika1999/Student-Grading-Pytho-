...
#f=fail
    ...
    if (p.isdigit()):#checking whether that the input ia a integer
        ...
        if (p == 0 or p == 20 or p==40 or p==60 or p==80 or p==100 or p==120):
            ...
            if(d.isdigit()):#checking whether that the input ia a integer
                ...
                if(d == 0 or d == 20 or d==40 or d==60 or d==80 or d==100 or d==120):
                    ...
                    if(f.isdigit()):#checking whether that the input ia a integer
...
while(is_y):
    ...
    if(condition=='y'):
        is_y=True
        return_val = find_progress_q2(result_count)
        print()
    elif(condition=='q'):
        is_y=False
        ...
        for l in range(0,max(result_count)):
            if(l<result_count[0]):
                print("  ","*",end="")
            else:
                print("    ",end="")
